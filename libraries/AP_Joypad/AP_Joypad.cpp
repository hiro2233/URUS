...
#if ((CONFIG_HAL_BOARD == HAL_BOARD_URUS) && ((CONFIG_SHAL_CORE == SHAL_CORE_APM) || (CONFIG_SHAL_CORE == SHAL_CORE_CYGWIN))) || (CONFIG_HAL_BOARD == HAL_BOARD_SITL) || (CONFIG_HAL_BOARD == HAL_BOARD_PX4) || (CONFIG_HAL_BOARD == HAL_BOARD_LINUX) || (CONFIG_HAL_BOARD == HAL_BOARD_CHIBIOS) || (CONFIG_HAL_BOARD == HAL_BOARD_F4LIGHT) || (CONFIG_HAL_BOARD == HAL_BOARD_VRBRAIN)
