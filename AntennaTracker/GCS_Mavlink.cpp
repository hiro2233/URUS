...
void GCS_MAVLINK_Tracker::handle_guided_request(AP_Mission::Mission_Command&)
{
    // do nothing
}
...
bool GCS_MAVLINK_Tracker::stream_trigger(enum streams stream_num)
{
